            ...
            <div className="flex min-h-screen flex-col">
                <div className="grid grid-cols-1 sm:grid-cols-2 pt-10">
                    <div className="grid place-items-center grid-cols-1 flex-grow">
                            <div className="place-items-center"> {/* xxs11:my-[5vh] xs:my-[12vh] xl:my-[9vw] 2xl:mt-7 2xl: */}
                                <div className="grid place-items-center text-center leading-tight">
                                    ...
                                    <p className="text-center xxs11:w-[150px] xxs8:w-[155px] xxs6:w-[160px] xxs4:w-[185px] xxs2:w-[230px] xxs:w-[250px] xs:w-full 2xl:w-auto xxs11:text-base xxs6:text-lg xxs4:text-xl xxs2:text-2xl xs:text-[18px] md:text-xl xl:text-2xl 2xl:text-3xl 2xl:mt-5 xxs11:mt-2 xxs4:mt-3 xs:mt-1 md:mt-2">
                                        Sign up and explore the world.
                                    </p>
                                </div>
                                <div className="xxs11:mt-2 xs:mt-3 md:mt-4 xl:mt-6">
                                    <div className="grid gap-y-3 xxs11:w-[200px] xxs10:w-[220px] xxs9:w-[240px] xxs8:w-[250px] xxs7:w-[270px] xxs6:w-[280px] xxs5:w-[290px] xxs4:w-[300px] xxs3:w-[310px] xxs2:w-[320px] xxs:w-[350px] xs:w-[270px] sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[450px] 2xl:w-[500px]">
                    ...
                    <div className="grid place-items-center grid-cols-1 flex-grow py-4" >
                        <div className="">
                            <img 
                                src={Image} 
                                className="w-full h-auto xxs11:px-20 py-4" 
                            />
                        </div>
                    </div>
                </div>
