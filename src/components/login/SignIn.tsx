                ...
                <div className="flex min-h-screen flex-col">
                    <div className="grid grid-cols-1 flex-grow">
                        <div className="grid-place-items-center">
                            <img 
                                src={Image} 
                                className="w-full h-full xs:px-[3vw]" 
                                style={{ objectFit: "contain" }} 
                            />
                        </div>

                        <div className="grid place-items-center m-0 2xl:pb-0 gap-y-2 text-start xxs:my-14 xs:my-11 sm:mt-10 sm:pb-28 md:pb-32 md:mt-14 lg:my-28 lg:mb-0 xl:mt-56 xl:mb-20 2xl:my-28">
                            <div className="">
                                ...
                                <div className="xxs2:mt-3 xs:mt-2 md:mt-3 xl:mt-4">
                                    <div className="grid gap-y-4 xxs11:w-[200px] xxs10:w-[220px] xxs9:w-[240px] xxs8:w-[250px] xxs7:w-[270px] xxs6:w-[280px] xxs5:w-[290px] xxs4:w-[300px] xxs3:w-[310px] xxs2:w-[320px] xxs:w-[350px] xs:w-[270px] sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[450px] 2xl:w-[500px]">
                                        ...
                                        <div className="flex items-center gap-1.5 w-full">
                                            ...
                                            <Label htmlFor="remember-me">Remember for 30 days | {w}px</Label>
                                        </div>
