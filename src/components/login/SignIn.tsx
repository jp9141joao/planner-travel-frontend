                    ...
                    <div className="grid grid-cols-1 flex-grow">
                        ...
                        <div className="grid place-items-center gap-y-2 text-start lg:my-[9vh] xl:my-[8vh] 2xl:my-[7vw]">
                            <div className="grid place-items-center">
                                ...
                                <div>
                                    <div className="grid place-items-center gap-y-4 xxs11:w-[200px] xxs10:w-[220px] xxs9:w-[240px] xxs8:w-[250px] xxs7:w-[270px] xxs6:w-[280px] xxs5:w-[290px] xxs4:w-[300px] xxs3:w-[310px] xxs2:w-[320px] xxs:w-[350px] xs:w-[270px] sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[450px] 2xl:w-[500px]">
