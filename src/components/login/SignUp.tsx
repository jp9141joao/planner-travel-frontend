            ...
            <MiddlePage>
                <div className='table mx-auto'>
                    <div className="grid text-center place-items-center leading-tight gap-y-0 text-gray-900 tracking-tight">
                            ...
                            <div>
                                <p className="xs:text-start text-[7vw] xxs8:text-[6.8vw] xs:text-[4.75vw] lg:text-[2.1vw] mt-[6.2vw] xxs5:mt-[6.4vw] xs:mt-[5.7vw] lg:mt-[2.2vw] leading-tight text-gray-900 tracking-tight">
                ...
                <div className="mx-[6vw] xxs3:mx-[6vw] xs:mx-[15.5vw] lg:mx-[2vw] my-[2.8vw] xxs5:my-[2.4vw] xs:my-0">
                    <img
                        src={Image}
