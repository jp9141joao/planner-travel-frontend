...
import Logo from '/Users/jp914/Desktop/planner-travel/src/assets/icons8-google-48.png';
import Image from '/Users/jp914/Desktop/planner-travel/src/assets/undraw_Travelers_re_y25a.png'
...
export default function SignIn () {
    ...
    return (
        <Card className="grid max-w-xl justify-center items-center">
            ...
            <CardContent className="max-w-xl">
                ...
                <div className="mt-4 grid w-full items-center gap-1.5">
                    <Button className="bg-color-purple hover:bg-hover-color-purple" type="submit">Sign in</Button>
                </div>
