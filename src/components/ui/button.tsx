  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-primary border bg-color-body-gray hover:bg-hover-color-gray hover:text-accent-foreground",
        secondary:
      ...
      size: {
        ...
        auto: "h-11 rounded-md w-full xs:w-auto xs:h-10 xs:px-4 sm:h-11 sm:px-8 lg:h-9 lg:px-3 xl:h-11 xl:px-8 2xl:h-12 2xl:px-20",
        icon: "h-7 w-12",
      },
    },
    defaultVariants: {
